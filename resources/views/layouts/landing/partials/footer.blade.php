    ...
    <div class="row g-5">
        <div class="col-lg-4 col-md-8">
            <div class="footer-item">
                ...
                <p style="text-align: justify;" class="mb-4">Kami adalah seorang petani lokal di Kelurahan Arjowinangun
                    ...
                    panen kami ke konsumen tanpa melalui perantara</p>
            </div>
        </div>
        <div class="col-lg-4 col-md-8">
        ...
        <div class="col-lg-4 col-md-8">
            <div class="d-flex flex-column text-start footer-item">
                ...
                <a class="btn-link text-white d-flex align-items-center"
                    href="https://www.instagram.com/tanimarket.fresh?igsh=MWJ6dWlrZXp0YmU1dQ==">
                    <i class="text-danger fab fa-instagram fa-2x pe-3"></i>@tanimarket.fresh
                </a>
            </div>
        </div>
    </div>
